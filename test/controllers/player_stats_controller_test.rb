...
class PlayerStatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_stat" do
    assert_difference('PlayerStat.count') do
      post player_stats_url, params: { player_stat: { name: @player_stat.name, value: @player_stat.value } }
    end
  ...
  test "should update player_stat" do
    patch player_stat_url(@player_stat), params: { player_stat: { name: @player_stat.name, value: @player_stat.value } }
